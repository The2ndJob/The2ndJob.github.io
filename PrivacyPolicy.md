...
The 2nd Job. ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by The 2nd Job.

This Privacy Policy applies to our website, https://the2ndjob.github.io, and its associated subdomains (collectively, our "Service") alongside our application, The 2nd Job.
...
*   **Company:** when this policy mentions “Company,” “we,” “us,” or “our,” it refers to <a>The 2nd Job</a> that is responsible for your information under this Privacy Policy.
*   **Country:** where <a>The 2nd Job</a> or the owners/founders of <a>The 2nd Joba</a> are based, in this case is <a>Viet Nam</a>.
*   **Customer:** refers to the company, organization or person that signs up to use the <a>The 2nd Job</a> Service to manage the relationships with your consumers or service users.
*   **Device:** any internet connected device such as a phone, tablet, computer or any other device that can be used to visit <a>The 2nd Job</a> and use the services.
*   **IP address:** Every device connected to the Internet is assigned a number known as an Internet protocol (IP) address. These numbers are usually assigned in geographic blocks. An IP address can often be used to identify the location from which a device is connecting to the Internet.
*   **Personnel:** refers to those individuals who are employed by <a>The 2nd Job</a> or are under contract to perform a service on behalf of one of the parties.
*   **Personal Data:** any information that directly, indirectly, or in connection with other information — including a personal identification number — allows for the identification or identifiability of a natural person.
*   **Service:** refers to the service provided by <a>The 2nd Job</a> as described in the relative terms (if available) and on this platform.
*   **Third-party service:** refers to advertisers, contest sponsors, promotional and marketing partners, and others who provide our content or whose products or services we think may interest you.
*   **Website:** <a>The 2nd Job</a>’s site, which can be accessed via this URL: <a>https://the2ndjob.github.io.</a>
*   **You:** a person or entity that is registered with <a>The 2nd Job</a> to use the Services.
...
The laws of Viet Nam, excluding its conflicts of law rules, shall govern this Agreement and your use of our service. Your use of our service may also be subject to other local, state, national, or international laws.
...
This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by The 2nd Job. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.
...
*   Via this Link: <a>https://github.com/The2ndJob/The2ndJob.github.io/issues</a>
